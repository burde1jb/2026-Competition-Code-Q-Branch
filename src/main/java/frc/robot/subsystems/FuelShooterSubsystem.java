...
public class FuelShooterSubsystem extends SubsystemBase {
    ...
    private SparkClosedLoopController FuelShooterMotorLoop3 = FuelShooterMotor3.getClosedLoopController();;
    ...
    private RelativeEncoder FuelShooterEncoder3 = FuelShooterMotor3.getEncoder();
    ...
    public FuelShooterSubsystem() {
        ...
        FuelShooterMotorConfig3.closedLoop
        .feedbackSensor(FeedbackSensor.kPrimaryEncoder);
        ...
        // SetupMotorConfig();
         ...
         .quadratureAverageDepth(2)
         .quadratureMeasurementPeriod(8);
         FuelShooterMotorConfig3.encoder //https://www.chiefdelphi.com/t/psa-rev-spark-default-velocity-filtering-is-still-really-bad-for-flywheels/514567/2
         .uvwMeasurementPeriod(8)
         .quadratureAverageDepth(2)
         .quadratureMeasurementPeriod(8);
        ...
        FuelShooterEncoder3.setPosition(0);
    }
    ...
    public void shooterOn(double velocity){
        ...
        FuelShooterMotorLoop3.setSetpoint(velocity, ControlType.kVelocity);
